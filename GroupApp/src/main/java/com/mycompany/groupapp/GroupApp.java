...
// Joat's code starts here
import java.util.ArrayList;
import java.util.Scanner; // Joat's code ends here

/**
 *
 * @author Joat and Group member 2
 */
import java.util.List; // Group member 2's code

public class GroupApp { // Group code

    public static void main(String[] args) { // Group code
        // Group member 2 code starts here
        UserManagement userManagement = new UserManagement();
        Scanner scanner = new Scanner(System.in);

        User adminUser = null; // Store the admin user once logged in... Group member 2's code ends here
        ...
        while(endLoop == false) { // Application loop for user interaction
            ...
            System.out.println("7. View previous POIs comments.\n"); // Joat's code ends here
            // Group member 2's code starts here
            ...
            try { // Handling user input with exception handling for non-integer inputs
                ...
                // Group member 2's code starts here
                    ...
                    String firstName = scanner.nextLine(); // variable name had to be changed from "name" to "firstName" as Joat's code has a variable with the same name... Group code
